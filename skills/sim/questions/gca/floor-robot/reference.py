"""Floor Robot: reference solution.

Facings in a fixed order so a turn is an index step, and the delta comes from
the same table. The alternative, a chain of conditionals per facing, is where
the off-by-one turns live.
"""
